...
from stocks.models import CoucheValorisation


class FIFOStrategy:
    """Premier entré, premier sorti.

    Chaque entrée crée une couche (CoucheValorisation) avec sa quantité et
    son prix. Les sorties consomment les couches les plus anciennes d'abord.
    """

    method_code = "FIFO"
    method_name = "Premier entré, premier sorti"
