...
class StandardCostStrategy:
    """Coût standard — le prix unitaire est fixe, donné à l'initialisation.

    Les entrées et sorties n'affectent pas le coût unitaire. Utile pour les
    articles dont le prix est administré (ex: prix de cession interne).
    """

    method_code = "STANDARD"
    method_name = "Coût standard"
